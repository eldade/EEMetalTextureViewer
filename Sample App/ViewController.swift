...
//        }
    ...
    func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing view: UIView?) -> UIView {
        let strokeTextAttributes = [
            ...
            convertFromNSAttributedStringKey(NSAttributedString.Key.font) : UIFont.systemFont(ofSize: 20, weight: UIFont.Weight.bold)
            ] as [String : Any]
        ...
        let attributedString = NSAttributedString(string: outputString, attributes: convertToOptionalNSAttributedStringKeyDictionary(strokeTextAttributes))
        ...
        if newView == nil {
            ...
            newView!.font = UIFont.systemFont(ofSize: 22, weight: UIFont.Weight.thin)
    ...
    func pickerView(_ pickerView: UIPickerView, attributedTitleForRow row: Int, forComponent component: Int) -> NSAttributedString? {
        let strokeTextAttributes = [
            ...
            convertFromNSAttributedStringKey(NSAttributedString.Key.foregroundColor) : UIColor.white,
            convertFromNSAttributedStringKey(NSAttributedString.Key.strokeWidth) : -3.0,
            convertFromNSAttributedStringKey(NSAttributedString.Key.font) : UIFont.systemFont(ofSize: 14, weight: UIFont.Weight.light)
            ] as [String : Any]
        ...
        return NSAttributedString(string: outputString, attributes: convertToOptionalNSAttributedStringKeyDictionary(strokeTextAttributes))
    }
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        case 0:
            ...
            metalView!.contentMode = UIView.ContentMode(rawValue: newContentMode!)!
